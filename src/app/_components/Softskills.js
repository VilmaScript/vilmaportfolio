const Softskills = () => {
  ...
  return (
    <div className="px-6 md:px-20 bg-[#1A152D] mt-5 ">
      ...
      <h2 className="text-xl sm:text-2xl mb-5 font-bold  text-accent text-center">
                        Soft Skills 
                    </h2>
      ...
      <ul className="space-y-4 max-w-2xl mx-auto">
        {skills.map((skill, index) => (
          <li
            key={index}
            className="border-b border-[#A259FF] text-xs sm:text-sm pb-3 text-gray-300 hover:text-white hover:pl-2 transition-all duration-200"
          >
