...
const VisitLink = () => {
    ...
    return (
        <div className="relative inline-block group ">
            <a href="https://glitzinteriors.vercel.app/" target="_blank" rel="noopener noreferrer"  className="relative px-7 py-1.5 rounded-full cursor-pointer  bg-primary z-10">Visit Project</a>
